...
Public Class rptsellfactorHospital
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptsellfactorHospital.rpt"
        End Get
    ...
    <Browsable(False), _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property Parameter_strtotalgrandprice() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptsellfactorHospital
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptsellfactorHospital = New rptsellfactorHospital
        rpt.Site = Me.Site
        Return rpt
    End Function
