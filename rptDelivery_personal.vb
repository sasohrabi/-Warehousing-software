...
Public Class rptDelivery_personal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDelivery_personal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDelivery_personal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDelivery_personal = New rptDelivery_personal
        rpt.Site = Me.Site
        Return rpt
    End Function
