...
Public Class rptSuppliers_personal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSuppliers_personal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSuppliers_personal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSuppliers_personal = New rptSuppliers_personal
        rpt.Site = Me.Site
        Return rpt
    End Function
